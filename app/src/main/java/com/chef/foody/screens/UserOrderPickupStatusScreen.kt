...
@Composable
fun UserOrderPickupStatusScreen(
        ...
        Text(
            ...
            Text(
                buildAnnotatedString {
                    ...
                    append(". Please wait for a few minutes. Once your order is ready, we will notify you. You can check the order status below. When your order is ready, you can go and pick it up at the following address: ")
                    withStyle(style = style) {
                        append("${customerCheckOrderStatusList.data.chef_address}")
                    }
                    append(".")
                },
                modifier = commonModifier
...
@Preview
@Composable
fun UserOrderPickupStatusScreenPreview() {
    UserOrderPickupStatusScreen()
}